...
static void wr_32(void *base) {
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,0d2c01cd : 46 */
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,167101cf : 91 */
	read(base, 0x408, IGNORE);
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,0ced0225 : 140 */
	read(base, 0x408, IGNORE);
	...
	/* 1,&hc_regs->hcdma,514,e0253000 : 168 */
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,06750227 : 187 */
	read(base, 0x408, IGNORE);
	...
	read(base, 0x50c, 0x00000006);
	/* 0,&hc_regs->hctsiz,510,00000200 : 193 */
	read(base, 0x510, 0x00000200);
	/* 0,&hc_regs->hctsiz,510,00000200 : 194 */
	read(base, 0x510, 0x00000200);
	...
	write(base, 0x50c, 0x00000006);
	/* 1,&host_if->hc_regs[hc_num]->hcchar,500,01081200 : 200 */
	write(base, 0x500, 0x01081200);
	...
	read(base, 0x2c, 0x00080100);
	/* 1,&hc_regs->hctsiz,510,00401000 : 207 */
	write(base, 0x510, 0x00401000);
	/* 1,&hc_regs->hcdma,514,d8824000 : 212 */
	write(base, 0x514, data);
	/* 0,&hc_regs->hcchar,500,01081200 : 213 */
	read(base, 0x500, 0x01081200);
	/* 1,&hc_regs->hcchar,500,81181200 : 214 */
	write(base, 0x500, 0x81181200);
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,002a0228 : 227 */
	read(base, 0x408, IGNORE);
	...
	read(base, 0x50c, 0x00000006);
	/* 0,&hc_regs->hctsiz,510,00000200 : 233 */
	read(base, 0x510, 0x00000200);
	/* 0,&hc_regs->hctsiz,510,00000200 : 234 */
	read(base, 0x510, 0x00000200);
	...
	write(base, 0x50c, 0x00000006);
	/* 1,&host_if->hc_regs[hc_num]->hcchar,500,01081200 : 240 */
	write(base, 0x500, 0x01081200);
	...
	read(base, 0x2c, 0x00080100);
	/* 1,&hc_regs->hctsiz,510,00401000 : 247 */
	write(base, 0x510, 0x00401000);
	/* 1,&hc_regs->hcdma,514,db6c5000 : 252 */
	write(base, 0x514, data);
	/* 0,&hc_regs->hcchar,500,01081200 : 253 */
	read(base, 0x500, 0x01081200);
	/* 1,&hc_regs->hcchar,500,81181200 : 254 */
	write(base, 0x500, 0x81181200);
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,107d022a : 267 */
	read(base, 0x408, IGNORE);
	...
	read(base, 0x50c, 0x00000006);
	/* 0,&hc_regs->hctsiz,510,00000200 : 273 */
	read(base, 0x510, 0x00000200);
	/* 0,&hc_regs->hctsiz,510,00000200 : 274 */
	read(base, 0x510, 0x00000200);
	...
	write(base, 0x50c, 0x00000006);
	/* 1,&host_if->hc_regs[hc_num]->hcchar,500,01081200 : 280 */
	write(base, 0x500, 0x01081200);
	...
	poll_value_with_max_tries(base + 0x2c, 0x00080100, 2000);
	read(base, 0x2c, 0x00080100);
	/* 1,&hc_regs->hctsiz,510,00401000 : 287 */
	write(base, 0x510, 0x00401000);
	/* 1,&hc_regs->hcdma,514,d7546000 : 292 */
	write(base, 0x514, data);
	/* 0,&hc_regs->hcchar,500,01081200 : 293 */
	read(base, 0x500, 0x01081200);
	/* 1,&hc_regs->hcchar,500,81181200 : 294 */
	write(base, 0x500, 0x81181200);
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,07c8022b : 307 */
	read(base, 0x408, IGNORE);
	...
	read(base, 0x50c, 0x00000006);
	/* 0,&hc_regs->hctsiz,510,00000200 : 313 */
	read(base, 0x510, 0x00000200);
	/* 0,&hc_regs->hctsiz,510,00000200 : 314 */
	read(base, 0x510, 0x00000200);
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,06b70232 : 353 */
	read(base, 0x408, IGNORE);
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,037b0280 : 402 */
	read(base, 0x408, IGNORE);
	...
	read(base, 0x14, 0x06400029);
	/* 0,&dwc_otg_hcd->core_if->host_if->host_global_regs->hfnum,408,171f0282 : 447 */
	read(base, 0x408, IGNORE);
